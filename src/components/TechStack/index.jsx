      ...
      <div className="techStackSec--head">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 1 }} onAnimationComplete={() => handleComplete()} className="techStackSec--head--detail">
          <p className="theme--detail">
            <ScrambleText delay={1}>Explore the technologies that define my craft: HTML5, CSS3, JavaScript, TypeScript, React, NextJs, Express.js, and Prisma. Each tool is carefully selected to create seamless, modern web experiences.</ScrambleText>
          </p>
        </motion.div>
      </div>
