  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/BenjaminBatres" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/benjamin-batres-9216b5329/" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={1}>
              LINKEDIN
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="/public/Resume/Benjamin Batres - Resume.pdf" download={"Benjamin_Batres-Resume.pdf"} rel="noopener noreferrer">
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Ben Batres"} noblink />
        <br />
